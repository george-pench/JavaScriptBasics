...
describe('ArraySorter object tests', () => {
  ...
  test('insertion sort', () => {
    const unsortedArray = [5, 3, 8, 4, 2]
    const sortedArray = [2, 3, 4, 5, 8]
    expect(ArraySorter.insertionSort([...unsortedArray])).toEqual(sortedArray)
  })

  test('insertion sort with an empty array', () => {
    expect(ArraySorter.insertionSort([])).toEqual([])
  })
  ...
  test('gnome sort with an empty array', () => {
    expect(ArraySorter.gnomeSort([])).toEqual([])
  })
})
